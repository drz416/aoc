...
#
# trajectory1: (Dx1(t1), Dy1(t1))
# trajectory2: (Dx2(t2), Dy2(t2))
#
# Intersection when:
# trajectory1 = trajectory2
# (Dx1(t1), Dy1(t1)) = (Dx2(t2), Dy2(t2))
#
# x intersection:
# Dx1(t1) = (Dx2(t2)) 
# mx1*t1 + bx1 = mx2*t2 + bx2
# > t2 = (mx1*t1 + bx1 - bx2) / mx2
# > substitute below
# 
# y intersection:
# Dy1(t1) = (Dy2(t2))
# my1*t1 + by1 = my2*t2 + by2
# > instert t2 from above
# my1*t1 + by1 = my2*(mx1*t1 + bx1 - bx2) / mx2 + by2
# my1*t1 - my2*mx1*t1 / mx2 = my2*(bx1 - bx2) / mx2 + by2 - by1
# t1 * (my1 - my2*mx1 / mx2) = my2*(bx1 - bx2) / mx2 + by2 - by1
# t1 = (my2*(bx1 - bx2) / mx2 + by2 - by1) / (my1 - my2*mx1 / mx2)
