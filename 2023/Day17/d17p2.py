...
4322674655533"""
    ...
    queue = [(0, 0, 0, 0, 1, 0)]   # The right traveling initial direction yields lowest
    seen = set()
    part2 = ""
    ...
    while queue:
        ...
        for next_dr, next_dc in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
            ...
            if next_dr == dr and next_dc == dc:
                if s >= 10:
                    continue # can only go max 10 positions in the same direction
                else:
                    heapq.heappush(
                        queue,
                        (
                ...
                if s < 4:
                    continue  # needs to travel at least 4 before it can turn
                else:
                    heapq.heappush(
                        queue,
